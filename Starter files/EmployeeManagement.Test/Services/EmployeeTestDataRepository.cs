...
{
    /// <summary>
    /// In memory implementation of the repository contract for testing purposes. Since our service is not bound by concreation
    /// but by a contract we have the flexibility to mock it like this, or with a mock framework and test our service in isolation
    /// </summary>
