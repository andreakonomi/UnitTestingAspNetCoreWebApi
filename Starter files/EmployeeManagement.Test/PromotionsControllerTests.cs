...
public class PromotionsControllerTests
{
    ...
    public async Task CreatePromotion_RequestPromotionForEligibleEmployee_MustPromoteEmployee()
    {
        ...
        // We will proceed constructing the promotion service to showcase mocking of http calls. Normally in this situation it would make sense to
        // directly mock the promotions service instead
